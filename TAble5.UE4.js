...
//	}
	...
	function withIndexedDB(db) {
		...
		// ----------------------------------------
		// MORE JS
		var dataJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/BAJIETyz/table2/32825711204e17d76b776aae0ec701f6f1ed86bc/TAble5.data.js'));
		var utilityJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/BAJIETyz/table2/32825711204e17d76b776aae0ec701f6f1ed86bc/Utility.js')).then(addScriptToDom);
		var dataDownload =
